...
df = pd.read_excel('./Planilhas/grade_cplex_pre.xlsx', sheet_name='solucao', usecols="A:D", nrows=956, header=None, names=['Professor', 'Turma', 'Dia', 'Horário'])
...
with pd.ExcelWriter('./Planilhas/grade_por_turma_CPLEX.xlsx', engine='openpyxl') as writer:
